...
with open("all_effector_wchap_genus_more100aa_CDHIT95_shortheaders_PAAR_4.domtblout",'r') as hmmsearch_file:
...
for k,v in all_targets.items():
	...
	for seq_record in SeqIO.parse("all_effector_wchap_genus_more100aa_CDHIT95_shortheaders_NOPAAR_3.fasta", "fasta"):
		header = str(seq_record.id)
		sequence = str(seq_record.seq).upper()
		if k in header[0:100]:
			with open("all_effector_wchap_genus_more100aa_CDHIT95_shortheaders_PAAR_4.fasta", "a+") as output_file:
...
for seq_record in SeqIO.parse("all_effector_wchap_genus_more100aa_CDHIT95_shortheaders_NOPAAR_3.fasta", "fasta"):
	...
	if header not in gotit:
		if header not in gotit2:
			with open("all_effector_wchap_genus_more100aa_CDHIT95_shortheaders_NOPAAR_4.fasta", "a+") as output_file:
				output_file.write(">" + header + "\n" + sequence + "\n")
